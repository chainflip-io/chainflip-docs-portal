...
<Steps>
    ### Initiating a swap
    This first step can be done through the [Swapping app](https://swap.chainflip.io/) (frontend), the [Javascript SDK](integrations/javascript-sdk/introduction), or directly using the [Chainflip CLI client](/brokers/broker-api/requests#broker_request_swap_deposit_address). There are two primary methods to start a Chainflip Swap:
