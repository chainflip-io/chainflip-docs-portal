...
<table>
    ...
    <tr>
        ...
        <td>
            Parameters to set a <a href="/brokers/swapping-basics#minimum-accepted-price-slippage-protection">minimum accepted price</a>.
...
Check the [Dollar Cost Average](/brokers/swapping-basics#dollar-cost-average-dca-improving-price) section for more information about the DCA feature.
...
|[<code>fillOrKillParams</code><span className="param-required-label">(required)</span>](/brokers/javascript-sdk/params#fillorkillparams) | Parameters to set a [minimum accepted price](/brokers/swapping-basics#slippage-protection-minimum-accepted-price) This allows to protect against price changes between a quote and the execution of a swap (also known as slippage protection).| <code>Object</code>|
