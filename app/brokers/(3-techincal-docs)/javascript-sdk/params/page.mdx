...
available for the asset pair and should not be set. Note: if overriding the default value -
This tolerance should cover network fees and broker fees. For example, if the network fee
is 10bps and the broker fee is 15bps - the live price slippage tolerance should be set to at
least 25bps to avoid refunds. The recommended value returned from the quote
