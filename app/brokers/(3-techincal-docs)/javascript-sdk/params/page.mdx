...
The Slippage Protection `fillOrKillParams` object sets a [minimum accepted price](/swapping/swapping-basics#minimum-accepted-price-slippage-protection) when initiating a swap.
...
The Cross-Chain Messaging optional `ccmParams` object enables to pass a [Cross-Chain Message](../../advanced/cross-chain-messaging/cross-chain-messaging)
