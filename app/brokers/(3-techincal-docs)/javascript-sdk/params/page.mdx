...
<Callout type="warning">
  ...
  the broker fee is 0.15% - the live price slippage tolerance should be set to
  at least 0.25% to avoid refunds. The recommended value returned from the quote
  <strong>already</strong> accounts for these fees.
</Callout>
