...
is 0.1% and the broker fee is 1.5% - the live price slippage tolerance should be set to at
least 0.25% to avoid refunds. The recommended value returned from the quote takes these fees into account.
