...
The Slippage Protection `fillOrKillParams` object sets a [minimum accepted price](/protocol/swapping-basics#minimum-accepted-price-slippage-protection) when initiating a swap.
