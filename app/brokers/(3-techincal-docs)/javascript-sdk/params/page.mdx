...
<Callout type="warning">
 Live price slippage protection is only available for asset pairs that have a recommended live price slippage tolerance. Note that this slippage execution is applied relative to the global index price of the asset and does NOT need to account for protocol or broker fees.
</Callout>
