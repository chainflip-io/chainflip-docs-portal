...
It is strongly recommended to use the provided [request_swap_parameter_encoding](/brokers/broker-api/requests#broker_request_swap_parameter_encoding) RPC rather than encoding the payload yourself.
</Callout>
...
<Callout type="info">
  ...
  Solana CCM swaps, it should be encoded as described in the [Solana CCM message section](/brokers/vault-swaps-api/solana#interface-references).
</Callout>