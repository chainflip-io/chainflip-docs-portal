  ...
  <Navbar
    logo={
      <div className="flex font-medium text-lg">
        ...
        <span
          className="custom-header hidden lg:flex text-xl font-semibold"
...
const footer = (
  <Footer className="flex-col items-center md:items-start">
    <p className="mt-2 text-xs">© {new Date().getFullYear()} Chainflip Docs.</p>
  </Footer>
);
    ...
    <html lang="en" dir="ltr" suppressHydrationWarning>
      ...
      >
        ...
        <meta
          ...
          content="Whether you're looking to integrate cross-chain swapping functionality, enable liquidity provisioning, or simply explore the potential of the Chainflip Protocol, these docs will serve as a valuable resource."
        />
