...
Repayments or collateral additions may remain enabled depending on Safe Mode level.
...
Yes. Under the unified pool model, all supplied assets become collateral and are deployed into the lending pool, earning interest from loans taken out against them.
BTC supply additionally earns Boost fees, as it is partially utilised to power Boosted swaps and deposits.
