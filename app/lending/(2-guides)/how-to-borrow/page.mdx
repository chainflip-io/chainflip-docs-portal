...
Connecting authenticates your **State Chain account**, which contains:
...
<Callout type="info">
  Your connected wallet is **not** the wallet holding your collateral - it only authenticates your
  account.
</Callout>
...
2. Click **Add Collateral**
   - This opens the _Transfer Funds_ modal
