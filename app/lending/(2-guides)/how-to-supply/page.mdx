...
- Your deposit becomes part of the **lending pool** and serves as **collateral** under the unified pool model
- Yield accrues from loans taken out against the pool
