---
title: Pricing, Matching & Stress Behaviour
...
Liquidation orders are flagged internally but remain permissionless — any LP can fill them.
...
- LP bots (including internal tools like Speer) continue operating
...
- No LP has priority — system remains fully permissionless
