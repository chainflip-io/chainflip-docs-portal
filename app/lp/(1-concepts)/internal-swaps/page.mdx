...
Liquidity providers that already have funds on Chainflip can initiate swaps (called "internal swaps") directly from their account balance.
...
- Internal swaps are cheaper since the user does not pay the ingress and egress [fees](/protocol/how-swapping-works#swap-fees-in-summary).

To initiate a swap the user can use the [lp_schedule_swap API](/lp/lp-api/requests#lp_schedule_swap).
