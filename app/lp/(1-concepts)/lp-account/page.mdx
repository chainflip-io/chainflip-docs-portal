...
description: Chainflip LP Account guide.
...
Upon [Funding](#funding-your-account) your account, your account will be created without any defined role. This account state is known as `Unregistered`. Unregistered accounts have access to basic functionality on the State Chain, such as redeeming funds and participating in tokenholder governance.

In order to integrate in the network, you will need to **register** the account for the [Liquidity Provider](/lp/lp-account) role.
