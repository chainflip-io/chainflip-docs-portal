...
<Callout type="info">This feature is available from version 1.9 onwards.</Callout>
...
Parameters:
_ spread_tick: [Tick](/lp/lp-api/types#tick),
_ base_asset: [Asset](/lp/lp-api/types#asset),
