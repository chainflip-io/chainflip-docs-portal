...
- [`boost_fee`](/lp/lp-api/types#boost-fee) (Optional): The maximum amount you are willing to pay to [boost](/lp/boost/how-boost-works) the deposit, expressed as basis points.
...
- `retry_duration`: A number of blocks for which the swap will be retried if it fails (see [FoK](/protocol/swapping-basics#slippage-protection-minimum-accepted-price) section).
- [`min_price`](#hex-price): The minimum price to swap at (see [FoK](/protocol/swapping-basics#slippage-protection-minimum-accepted-price) section).
