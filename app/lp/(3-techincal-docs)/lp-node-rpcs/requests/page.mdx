...
Returns the free balances of all assets for a specified account at the current best block. Note that 'Free Balances' does _not_ include any assets currently active in LP orders or in boost pools.
