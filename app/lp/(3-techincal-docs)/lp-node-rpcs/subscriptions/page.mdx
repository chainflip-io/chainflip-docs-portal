...
### `cf_subscribe_prewitness_swaps`<span className="badge-danger after:content-['Deprecated']"/>
...
> [!WARNING]
>
> Because these are witnessed *before* confirmation, they are not guaranteed to be executed *at all* or at that time, since blockchains can re-org.
