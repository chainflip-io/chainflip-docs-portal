...
description: The state chain node subscriptions that are useful for liquidity providers.
---
...
- `base_asset`: [Asset](/lp/lp-api/types#asset)
- `quote_asset`: [Asset](/lp/lp-api/types#asset)
- `side`: [Side](/lp/lp-api/types#side)
- `amount`: [Amount](/lp/lp-api/types#amount) - The size of the swap chunk.
- `source_asset`: [Asset](/lp/lp-api/types#asset) (optional)
- `source_amount`: [Amount](/lp/lp-api/types#amount) (optional)
- `execute_at`: number
...
<Callout type="error">
  THIS SUBSCRIPTION IS DEPRECATED. Use [cf_subscribe_pool_price_v2](#cf_subscribe_pool_price_v2)
  instead.
</Callout>
...
It returns the price at the time of beginning the subscription as the first item in the stream. Subsequent items are only returned if there is a _change_ in the price.

Parameters:

- `from_asset`: [Asset](/lp/lp-api/types#asset)
- `to_asset`: [Asset](/lp/lp-api/types#asset)

Returns:

- `price`: [Price](/lp/lp-api/types#price)
- `sqrt_price`: [Square Root Price](/lp/lp-api/types#square-root-price)
- `tick`: [Tick](/lp/lp-api/types#tick)
...
- `block_hash`: string
- `block_number`: number
- `sell`: Option\<[Square Root Price](/lp/lp-api/types#square-root-price)\>
- `buy`: Option\<[Square Root Price](/lp/lp-api/types#square-root-price)\>
- `range_order`: [Square Root Price](/lp/lp-api/types#square-root-price)
