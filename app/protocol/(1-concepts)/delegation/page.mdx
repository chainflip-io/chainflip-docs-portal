...
The simplest way for **Delegators** to, well, delegate, is to interact directly from their Ethereum wallets. Assuming you already own some $FLIP tokens go to the [staking page](https://auctions.perseverance.chainflip.io/delegate) and follow the instructions.
