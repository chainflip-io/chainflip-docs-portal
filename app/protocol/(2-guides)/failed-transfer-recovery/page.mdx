...
- In EVM chains, a native asset transfer (e.g. Eth) can fail if the recieving address is a smart contract executes logic that consumes more than 8000 gas on the receive logic. Regular multisigs are supported.
