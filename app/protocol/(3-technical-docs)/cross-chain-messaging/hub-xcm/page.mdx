...
### Overview
The Chainflip CCM functionality allows users to swap any asset into one of the [supported Assets on Assethub](/protocol/supported-chains-assets/chains-assets#assets) and then submit an extrinsic on Assethub, including [XCM extrinsics](https://docs.polkadot.com/develop/interoperability/intro-to-xcm/).
