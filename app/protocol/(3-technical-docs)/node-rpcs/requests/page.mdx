...
title: Protocol Node RPC Requests

description: State Chain node RPC requests for protocol developers.
...
```json
{
  ...
  "result": {
    ...
    "Tron": [
      "TX8VqM3w9rJftks1UfqntGpdbp9npPUbyu"
    ]
  },
  "id": "1"
}
...
```json
{
  ...
  "result": {
    ...
    "Tron": [
      {
        "name": "tron_vault_contract",
        "address": "TMkw4gZgD4sDFLtnCu3tW1v2vETdG76MrN",
        "explanation": "Holds TRX and all tokens on Tron. Directly receives user funds in case of smart contract-based vault swaps.",
        "rotation_policy": "Never",
        "next_predicted_rotation": null
      }
    ]
