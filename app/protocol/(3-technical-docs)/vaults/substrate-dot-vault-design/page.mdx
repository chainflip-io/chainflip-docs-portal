...
description: How Chainflip’s Substrate Vault secures DOT using Polkadot primitives such as pure proxy accounts, derivative deposit addresses, batch calls, Schnorr signatures, AggKey control, fund sweeping, and Vault rotations.
