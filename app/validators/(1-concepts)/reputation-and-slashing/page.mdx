...
The reputation and slashing system only applies to Authorities.
Bidding validators outside of the Authority Set can never be slashed.
...
Note that any Validator that does not enter the Authority Set after the auction will have their reputation reset to zero (ie. Neutral) at the beginning of a new epoch.
