...
<Callout type="warning">
Your redemption process has not finished, you have simply signalled to the Network that you want to redeem. You **must** continue the redemption process on the Auctions page (after a 48hr wait); you **must** redeem during the Execution window.
</Callout>
