...
The redemption process is initiated via the [Chainflip Auctions App](https://auctions.chainflip.io/auctions) > **My Nodes (legacy)** alongside the Chainflip CLI. You will need the address of the Ethereum account to which you want your `$FLIP` to be sent.
