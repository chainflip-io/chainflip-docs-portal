...
If you *do* lose access to these keys, you can [recover your validator account](keys#recovering-your-keys) and restore it to a state where it can participate in the network again.
