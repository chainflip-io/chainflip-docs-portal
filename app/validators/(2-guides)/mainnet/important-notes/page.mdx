...
- If you think the keys might be compromised, we recommend that you immediately secure your `$FLIP` funds by [binding a redeem address](../funding/advanced-account-management#redemption-execution-address-binding), [stopping your bid](../funding/funding-and-bidding#stop-bidding) and then, when your funds are unbonded, redeeming them to your wallet before funding a new node with new keys.
