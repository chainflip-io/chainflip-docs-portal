...
You must ensure that the public Ethereum address generated above has at least **0.2 ETH** on Ethereum Mainnet, **0.1 ETH** on Arbitrum and **300 TRX** on Tron. The protocol regularly refunds the fees paid to the paying address. You should monitor this balance to ensure it doesn't fall below the required amount.
