...
<br />
<img
  src="/testnet/validaotr_cli_commands_failing.png"
  alt="validator cli commands failing(command already executed before)"
/>
<br />
...
<Callout type="warning">
  Make sure that both endpoints (HTTP and WebSockets) are accessible. Otherwise your engine will
  fail to start.
</Callout>
