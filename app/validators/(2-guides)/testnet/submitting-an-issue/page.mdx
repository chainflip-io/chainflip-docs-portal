...
title: Submitting an Issue on Testnet

description: This is the official way to report an issue on Testnet
...
For general help, the [`🧪︱testnet-discussion`](https://discord.com/channels/824147014140952596/1025410114875834408) channel in the **Perseverance Testnet** Discord category is a good place to start.\
\
